...
Ontario’s **Workforce Priority** stream (from 26 June 2026) is one worker stream with **three calculator pathways** on this product. They share the same regulation. They do not share the same practical ceiling.

Official page: [Ontario Workforce Priority stream](https://www.ontario.ca/page/ontario-workforce-priority-stream)

---

## 1. Skilled job offer (TEER 0 to 3)

- **URL:** [oinp.getnorthpath.com/calculator/skilled-teer-0-3](https://oinp.getnorthpath.com/calculator/skilled-teer-0-3)
- **Who:** Eligible Ontario job offer in management, professional, or technical work (NOC TEER 0, 1, 2, or 3)
- **Max score:** **130**
- **TEER points:** 9 (TEER 0 or 1) or 6 (TEER 2 or 3)
- **Typical extras:** Employer must file first; you then register an EOI. TEER 0 to 3 nominees can often proceed through **Express Entry** (an accepted nomination adds **600 CRS**)

Eligibility is not the same as points. Common gates include consecutive experience in the offered position, language minimums (often **CLB 6**, **CLB 5** for listed trades), education, and employer checks.

---

## 2. Essential job offer (TEER 4 to 5)

- **URL:** [oinp.getnorthpath.com/calculator/essential-teer-4-5](https://oinp.getnorthpath.com/calculator/essential-teer-4-5)
- **Who:** Eligible Ontario job offer in essential occupations (examples: personal support work, some food service and related roles)
- **Max on the grid:** 130
- **Practical ceiling:** about **121 / 130** because TEER 4 and 5 score **0** on the occupation TEER factor
...
A physician at 90 / 115 is not “weaker” than a worker at 90 / 130. The denominators differ.
