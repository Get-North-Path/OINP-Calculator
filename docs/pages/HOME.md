...
5. Optionally request a **free GetNorthPath consult** (calculator answers go with the request)

No signup is required to score.
...
## Score groups on this page

| Group | Up to |
| --- | --- |
| Occupation (NOC TEER + category) | 34 pts combined in the UI (TEER 9 + category 10, plus wage sits in the occupation step) |
| Canadian work and status | 36 pts (experience 18 + earnings 8 + status 10) |
| Education | 20 pts |
| Language | 25 pts |
| Region | 15 pts |

Physician mode drops the wage factor; max becomes **115**. Dedicated page: [PHYSICIANS.md](PHYSICIANS.md).

---

## Related pages

- [Skilled calculator](https://oinp.getnorthpath.com/calculator/skilled-teer-0-3)
- [Essential calculator](https://oinp.getnorthpath.com/calculator/essential-teer-4-5)
- [Physicians](https://oinp.getnorthpath.com/calculator/physicians)
- [Compare scenarios](https://oinp.getnorthpath.com/calculator/compare-scenarios)
- [All 11 scoring factors](https://oinp.getnorthpath.com/guide/eoi-scoring-factors)

**Official source:** [Ontario Workforce Priority stream](https://www.ontario.ca/page/ontario-workforce-priority-stream)
